...
export REPO_ROOT=~/assets/workspace-scaffold
...
alias app1='ssh ahmet@10.10.99.18 -p 6353'
alias app2='ssh ahmet@10.10.99.28 -p 6353'
#alias chat='ssh ahmet@10.10.99.23 -p 6353'
alias elk='ssh ahmet@10.10.99.15 -p 6353'
alias gitserver='ssh ahmet@10.10.99.12 -p 6353'
alias grafana='ssh ahmet@10.10.99.19 -p 6353'
alias jira='ssh ahmet@10.10.99.16 -p 6353'
alias k8s-master='ssh ahmet@10.10.99.32 -p 6353'
alias k8s-worker1='ssh ahmet@10.10.99.33 -p 6353'
alias k8s-worker2='ssh ahmet@10.10.99.34 -p 6353'
alias k8s-worker3='ssh ahmet@10.10.99.35 -p 6353'
alias kafka-prod='ssh ahmet@10.10.99.36 -p 6353'
alias kyc-prod='ssh ahmet@10.10.99.30 -p 6353'
alias nextcloud='ssh ahmet@10.10.99.40 -p 6353'
alias postgresql-prod='ssh ahmet@10.10.99.37 -p 6353'
alias prod-dns='ssh ahmet@10.10.99.24 -p 6353'
alias prod-mkk='ssh ahmet@10.10.99.29 -p 6353'
alias prod-rabbitmq='ssh ahmet@10.10.99.26 -p 6353'
alias prod-redis='ssh ahmet@10.10.99.25 -p 6353'
alias prod-tde='ssh ahmet@10.10.99.41 -p 6353'
alias prod-turn='ssh ahmet@10.10.99.22 -p 6353'
alias prometheus='ssh ahmet@10.10.99.20 -p 6353'
alias quest-prod='ssh ahmet@10.10.99.38 -p 6353'
alias runner='ssh ahmet@10.10.99.17 -p 6353'
alias s3='ssh ahmet@10.10.99.14 -p 6353'
alias sonar='ssh ahmet@10.10.99.21 -p 6353'
alias tradingview='ssh ahmet@10.10.99.39 -p 6353'
alias vault='ssh ahmet@10.10.99.13 -p 6353'
alias wazuh-dlp='ssh ahmet@10.10.99.31 -p 6353'
alias kafka-pp='ssh ahmet@192.168.202.23 -p 6353'
alias postgres-tde='ssh ahmet@192.168.202.24 -p 6353'
alias pp-app1='ssh ahmet@192.168.202.17 -p 6353'
alias pp-app2='ssh ahmet@192.168.202.13 -p 6353'
alias pp-db='ssh ahmet@192.168.202.19 -p 6353'
alias pp-dns='ssh ahmet@192.168.202.11 -p 6353'
alias pp-kb-app01='ssh ahmet@192.168.202.151 -p 6353'
alias pp-kb-db01='ssh ahmet@192.168.202.153 -p 6353'
alias pp-kb-turn01='ssh ahmet@192.168.202.157 -p 6353'
alias pp-kyc='ssh ahmet@192.168.202.18 -p 6353'
alias pp-mkk='ssh ahmet@192.168.202.20 -p 6353'
alias pp-rabbitmq='ssh ahmet@192.168.202.14 -p 6353'
alias pp-redis='ssh ahmet@192.168.202.15 -p 6353'
alias pp-runner='ssh ahmet@192.168.202.16 -p 6353'
alias pp-turn='ssh ahmet@192.168.202.12 -p 6353'
alias questdb-pp='ssh ahmet@192.168.202.22 -p 6353'
alias test-app3='ssh ahmet@192.168.201.27 -p 6353'
alias blockchain-1='ssh ahmet@192.168.201.22 -p 6353'
alias blockchain-2='ssh ahmet@192.168.201.23 -p 6353'
